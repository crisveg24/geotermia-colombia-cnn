...
| [ANALISIS_ENTRENAMIENTO.md](ANALISIS_ENTRENAMIENTO.md) | Análisis detallado del entrenamiento |
| [MEJORAS_MODELO.md](MEJORAS_MODELO.md) | Roadmap de optimizaciones del modelo |
...
3. **ENTRENAMIENTO_EXTERNO.md** - Si vas a entrenar en otra máquina
4. **ANALISIS_ENTRENAMIENTO.md** - Para entender los resultados
